...
public class TaskModulePanel extends JPanel {
    ...
    private JPanel createTaskRow(TaskItem task) {
        ...
        if (moduleType == OriginModule.WORK) {
            JLabel workTypeLabel = new JLabel("[" + (task.getTaskType().isEmpty() ? "General" : task.getTaskType()) + "]");
    ...
    private void addTask(String text) {
        ...
        if (moduleType == OriginModule.WORK) newTask.setTaskType("Studio Dev");
    ...
    private void showEditDialog(TaskItem task) {
        ...
        JTextField workTypeField = new JTextField(task.getTaskType());
        ...
        if (task.getOriginModule() == OriginModule.WORK) {
            panel.add(new JLabel("Task Type:")); panel.add(workTypeField);
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            if (task.getOriginModule() == OriginModule.WORK) {
                task.setTaskType(workTypeField.getText().trim());
                try {
